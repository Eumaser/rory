...
class ControllerAccountOrder extends Controller {
	...
	public function index() {
		...
		//print_r($this->language->get('date_format_short'));die();
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/account/order_list.tpl')) {
			//die('faps');
		//	$this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/account/order_list.php', $data));
