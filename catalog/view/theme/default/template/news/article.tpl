...
<div class="article-content">
	<?php if ($edr_image_a): ?>
			<img src="<?php echo 'image/'.$edr_image_a ?>" alt="">
	<?php endif; ?>

	<div class="article-meta">
		<h3 class="color-article-title">	<?php echo $heading_title ?></h3>
	  <span class="color-articles"><?php echo strtoupper(date('F d, Y', strtotime($date_added) )); ?></span> |
		<?php if($category) { ?>
			<span class="color-articles"><?php echo strtoupper( $category); ?> |</span>
		<?php } ?>
		<?php if ($comment): ?>
			<span class="color-articles">	<?php echo count($comment) ?> - COMMENTS</span>
		<?php else: ?>
			<span class="color-articles">0 - COMMENTS</span>
		<?php endif; ?>
