...
<?php if ($shipping) { ?>
<table class="table shipping-method-table">
...
<div <?php echo $delivery_required ? ' class="required"' : ''; ?> >
  ...
  <?php } else { ?>
  	<input type="text" placeholder="<?php echo $text_delivery; ?>" name="delivery_date" value="<?php echo $delivery_date; ?>" class="form-control date" data-date-format="DD-MM-YYYY" />
  <?php } ?>
