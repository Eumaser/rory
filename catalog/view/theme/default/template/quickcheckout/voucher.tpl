...
<div id="coupon-heading">
  <img src="image/catalog/rory/Icons/coupon.png" alt="asdasd"> <?php echo $entry_coupon; ?>
</div>
...
<div id="voucher-heading">
  <img src="image/catalog/rory/Icons/gift_black.png" alt="asdasd">  <?php echo $entry_voucher; ?>
</div>
