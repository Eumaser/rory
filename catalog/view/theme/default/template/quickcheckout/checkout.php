...
<div class="container">
  ...
  <div class="row">
    ...
    <?php if (!$logged): ?>
      <p>
        Already registered? Click <a class="data-login" href="<?php echo $data_login ?>">here</a> to login
      </p>
    <?php endif; ?>
    ...
    <!---guest form-->
	  ...
	  <div class="quickcheckoutright" style="float:right; margin-left:0px">
  		<?php if ($shipping_required) { ?>
      ...
      <div id="shipping-method">
          ...
          <!--Delivery Method-->
    		...
    		<?php } ?>
          <!--Payment Method-->
    		  <div class="quickcheckout-heading" style="margin-top:25px;">
        ...
        <?php } ?>
    	  ...
    	  <?php } ?>
    		<div id="cart1">
    		  <div class="quickcheckout-heading">
            <i class="fa fa-check-square-o"></i> <?php echo $text_checkout_confirm; ?>
          </div>
    		  <div class="quickcheckout-content" style="border:none; padding: 0px;"></div>
    		</div>
    	  </div>
