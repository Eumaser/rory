...
class ControllerQuickCheckoutCheckout extends Controller {
	public function index() {
		...
		$data['data_login'] = $this->url->link('account/login', '', 'SSL');
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/quickcheckout/checkout.php')) {
			$this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/quickcheckout/checkout.php', $data));
