...
class ControllerCommonCart extends Controller {
	...
	//	print_r($data);die();
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/common/cart.php')) {
			return $this->load->view($this->config->get('config_template') . '/template/common/cart.php', $data);
