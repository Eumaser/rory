...
class ControllerModuleMailchimpIntegration extends Controller {
	...
	public function index() {
		...
		$template = (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/' . $this->type . '/' . $this->name . '.php')) ? $this->config->get('config_template') : 'default';
		$template_file = $template . '/template/' . $this->type . '/' . $this->name . '.php';
