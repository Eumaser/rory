...
class ControllerProductProduct extends Controller {
	...
	public function index() {
		...
		//	print_r($product_info['image']);die();
			...
			foreach ($results as $result) {
				if ($result['image']) {
					...
					$nmage  =  $this->model_tool_image->resize($result['image'], 200, 200);
				//	$nmage  = $result['image'];
				} else {
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/product/product.php')) {
				$this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/product/product.php', $data));
